...
> 조회위주의 도메인이며, 조회 트래픽이 쓰기 트래픽에 비해 월등히 높은 수준일때 고려하는 "최후의 보루"
- 애플리케이션 트랜잭션 시 데이터 일관성을 보장할 수 있는 장치가 필수적.
- 테이블 통합은 고려할 수는 있으나, 데이터의 생명주기 및 책임 도메인이 다르다면 과감하게 분리한다(SRP 원칙)
